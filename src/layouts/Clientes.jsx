        ...
        <>
            <section className="py-16">
                <div className="flex justify-center items-center pb-16">
                    <p className="text-3xl md:text-5xl font-bold border-b-4 border-primary">Nuestros Clientes</p>
                </div>
                ...
                <section className="bg-[#f2f5f7] py-16">
                    <div className="flex justify-center items-center md:pb-16">
                        <p className="text-3xl md:text-5xl font-bold border-b-4 border-primary">Trabajos Realizados</p>
                    </div>
